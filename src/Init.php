...
$di->setter['Ushahidi\Core\Usecase\User\LoginUser']['setRateLimiter'] = $di->lazyGet('ratelimiter.flaps');
$di->setter['Ushahidi\Core\Usecase\User\LoginUser']['setThrottlingStrategy'] = $di->lazyGet('ratelimiter.flaps.throttling');
