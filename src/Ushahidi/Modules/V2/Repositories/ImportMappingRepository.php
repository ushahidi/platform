...
namespace Ushahidi\Modules\V2\Repositories;

use Ushahidi\Modules\V2\ImportMapping;
use Ushahidi\Modules\V2\Contracts\ImportMappingRepository as ImportMappingRepositoryContract;
