...
class CoreConfig extends ContainerConfig
{
    ...
    public function define(Container $di): void
    {
        ...
        $di->set('factory.validator', $di->lazyNew(\Ushahidi\Modules\V3\Factory\ValidatorFactory::class));

        // Implemented validators will be mapped to resources and actions.
        $di->params[\Ushahidi\Modules\V3\Factory\ValidatorFactory::class]['map'] = [];

        // Authorizers are used to check if the accessing user has permission to use an action.
        $di->set('factory.authorizer', $di->lazyNew(\Ushahidi\Modules\V3\Factory\AuthorizerFactory::class));

        // Authorizers are shared, so mapping is done with service names.
        $di->params[\Ushahidi\Modules\V3\Factory\AuthorizerFactory::class]['map'] = [
        ...
        $di->set('factory.repository', $di->lazyNew(\Ushahidi\Modules\V3\Factory\RepositoryFactory::class));

        // Repositories are shared, so mapping is done with service names.
        $di->params[\Ushahidi\Modules\V3\Factory\RepositoryFactory::class]['map'] = [
        ...
        $di->set('factory.formatter', $di->lazyNew(\Ushahidi\Modules\V3\Factory\FormatterFactory::class));

        // Implemented collection formatter will register as the factory.
        $di->params[\Ushahidi\Modules\V3\Factory\FormatterFactory::class]['factory'] = null;
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\FormatterFactory::class]['collections'] = [
            'search' => true,
            'update_collection' => true
        ];

        // Data transfer objects are used to carry complex search filters between collaborators.
        $di->set('factory.data', $di->lazyNew(\Ushahidi\Modules\V3\Factory\DataFactory::class));

        // Usecases that perform searches are the most typical usage of data objects.
        $di->params[\Ushahidi\Modules\V3\Factory\DataFactory::class]['actions'] = [
        ...
        $di->set('factory.usecase', $di->lazyNew(\Ushahidi\Modules\V3\Factory\UsecaseFactory::class));
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['actions'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['form_roles'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['form_stats'] = [
            'search'  => $di->lazyNew(Usecase\Form\SearchFormStats::class),
        ];

        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['form_stages'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['media'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['csv'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['messages'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['posts'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['notifications'] = [
            'create'  => $di->lazyNew(Usecase\Notification\CreateNotification::class)
        ];

        // Add custom create usecase for webhooks
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['webhooks'] = [
            'create'  => $di->lazyNew(Usecase\Webhook\CreateWebhook::class)
        ];

        // Add custom create usecase for export jobs
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['export_jobs'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['contacts'] = [
            'create'  => $di->lazyNew(Usecase\Contact\CreateContact::class)
        ];

        // Add custom create usecase for terms of service
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['tos'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['sets_posts'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['posts_lock'] = [
        ...
        // Add custom usecases for sets_posts
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['savedsearches'] = [
            'create' => $di->lazyNew(Usecase\Set\CreateSet::class),
        ];

        // Add custom usecases for sets_posts
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['sets'] = [
            'create' => $di->lazyNew(Usecase\Set\CreateSet::class),
        ];

        // Add usecase for posts_export
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['posts_export'] = [
        ...
        $di->params[\Ushahidi\Modules\V3\Factory\UsecaseFactory::class]['map']['users'] = [
