...
class Category extends BaseModel
{
    ...
    {
        return $this->hasOne('Ushahidi\Modules\V5\Models\Category', 'id', 'parent_id');
    }
    public function children()
    {
        return $this->hasMany('Ushahidi\Modules\V5\Models\Category', 'parent_id', 'id')->withoutGlobalScopes();
    }
