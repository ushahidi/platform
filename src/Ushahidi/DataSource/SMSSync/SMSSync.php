...
class SMSSync implements CallbackDataSource
{
    ...
    {
        $router->post('sms/smssync', 'Ushahidi\DataSource\SMSSync\SMSSyncController@handleRequest');
        $router->post('smssync', 'Ushahidi\DataSource\SMSSync\SMSSyncController@handleRequest');
        $router->get('sms/smssync', 'Ushahidi\DataSource\SMSSync\SMSSyncController@handleRequest');
        $router->get('smssync', 'Ushahidi\DataSource\SMSSync\SMSSyncController@handleRequest');
    }
