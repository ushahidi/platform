...
// The `ConfidenceScoreAuthorizer` class is responsible for access checks on `ConfidenceScores`
class ConfidenceScoreAuthorizer implements Authorizer
{
    ...
    // It requires a `ConfidenceScoreRepository` to load parents too.
