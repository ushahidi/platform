...
namespace Ushahidi\Core\Usecase\ConfidenceScore;
...
class CreateConfidenceScore implements Usecase
{
    ...
    use Usecase\Concerns\ModifyRecords;
     ...
     * @return $this
     */
    public function setRepository(ConfidenceScoreRepository $repo)
    {
        $this->repo = $repo;
        return $this;
    }
