																					...
																					<tr>
																						<td align="left">
																							<a target="_blank" href="#">
																								<img src="http://github.ushahidi.org/platform-pattern-library/assets/img/ushahidi-wordmark-fullcolor.png" border="0" width="117" height="24" alt="Ushahidi" style="vertical-align: top; width: 117px; height: 24px;" />
																							</a>
																						</td>
																					</tr>
																				</table>
																				...
																				<table cellpadding="0" cellspacing="0" width="100%">
																					<tr>
																						<td align="left" style="padding: 24px 0 16px;">
																							<a target="_blank" href="#">
																								<img src="img/logo.png" border="0" width="117" height="24" alt="Ushahidi" style="vertical-align: top; width: 117px; height: 24px;" />
																							</a>
																						</td>
																					</tr>
																					<tr>
