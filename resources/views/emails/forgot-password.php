		...
		<table align="center" class="flexible" cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td bgcolor="#ffffff" align="center" valign="top"
					style="margin:0;padding:0;border:0;width:100%!important;background: #ffffff">
					<table class="flexible" align="center" cellpadding="0" cellspacing="0" border="0" width="600">
						<tr>
							<td>
								<table class="flexible" align="center" cellpadding="0" cellspacing="0" border="0"
									width="600">
									<tr>
										<td style="background: #ffffff; padding: 24px 15px 40px;">
											<table class="flexible" align="left" cellpadding="0" cellspacing="0" border="0"
												width="600">
												<tr>
													<td>
														<table class="flexible" width="600" align="left"
												...
												<tr>
													<td>
														<table class="flexible" width="600" align="center"
															...
															<tr>
																<td
																	style="padding:24px; border: 1px solid #D3D4D5; border-radius: 8px;">
																	<table cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td style="padding: 0 0 40px;">
																				<table cellpadding="0" cellspacing="0"
																					...
																					<tr>
																						<td align="left"
																							style="font:24px/29px Open Sans, Arial, Helvetica, sans-serif; font-weight: 500; color: #181B21; padding: 0 0 8px;">
																							Reset your password
																						</td>
																					</tr>
																					<tr>
																					...
																					<tr>
																						<td align="left"
																							style="font:16px/24px Open Sans, Arial, Helvetica, sans-serif; font-weight: normal; color: #383E45; padding: 0 0 8px;">
																						...
																						<tr>
																							<td align="center"
																								...
																								<a href="<?php echo $client_url . '/forgotpassword/confirm/' . urlencode($reset_string); ?>"
																									class="btn"
																									style="font:16px/20px Open Sans, Arial, Helvetica, sans-serif; display: block; text-decoration: none; font-weight: 500; color: #181B21; padding: 10px; background: #FFC235; border-radius: 4px;">
																									Recover Password
																								</a>
																							</td>
																						</tr>
																					...
																					<tr>
																						<td align="left"
																							...
																							<table cellpadding="0"
																								...
																								<tr>
																									<td align="center"
																										style="font:14px/21px Open Sans, Arial, Helvetica, sans-serif; font-weight: 700; text-align: center; color: #383E45; padding: 16px; word-break:break-all; background: #F5F5F5; border-radius: 8px;">
																										<?php echo $reset_code; ?>
																									</td>
																								</tr>
																							</table>
																		...
																		<tr>
																			<td
																				style="border-top: 1px solid #D3D4D5; padding: 8px 0 0;">
																				<table cellpadding="0" cellspacing="0"
																					width="100%">
																					<tr>
																						<td align="left"
																					...
																					<tr>
																						<td align="left"
																							style="font:14px/18px Open Sans, Arial, Helvetica, sans-serif; font-weight: normal; color: #383E45; padding: 0 0 16px;">
																							Ushahidi empowers people through
																							citizen-generated data to
