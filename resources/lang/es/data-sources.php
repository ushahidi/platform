...
return [
    'In order to receive posts by email, please input your email account settings below' => 'Para poder recibir publicaciones por correo electrónico,'.
    ...
    'Scan this QR Code with your phone to download the app from the Android Market <img src="'.url('/images/smssync.png').'" width="150"/>' => 'Escanee este código QR con su teléfono para descargar la aplicación desde el Android Market'.url('/images/smssync.png').'" width="150"/>',
    'Turn on SMSSync and use the following link as the Sync URL:'.url('sms/smssync') => 'Active SMSSync y use el siguiente enlace como el URL de sincronización:'.url('sms/smssync'),
    ...
    'Create a <a href="https://developer.twitter.com/en/apps/create">new twitter application</a>' => 'Cree una <a href="https://developer.twitter.com/en/apps/create">nueva aplicación de twitter</a>',
