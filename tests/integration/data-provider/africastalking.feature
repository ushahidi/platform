@dataproviders
Feature: Testing the Africas Talking Data Provider

    Scenario: Submit a message to africas talking controller
        ...
        When I request "sms/africastalking"
        Then the response is JSON
        And the "success" property is true
        Then the guzzle status code should be 200

    Scenario: Submit a message to africas talking controller with no message
        Given that I want to find a "Message"
        And that the request "query string" is:
            """
    ...
    Scenario: Submit a message to africas talking controller with no from
        Given that I want to find a "Message"
        And that the request "query string" is:
            """
