...
Feature: Testing the Posts API
	...
	Scenario: Creating a new Post
		...
		And the "result.values.last_location_point.0.lat" property equals "33.755"
		And the "result.values.geometry_test" property contains "POLYGON((0 0,1 1,2 2,0 0))"
		And the "result.values.links.0" property equals "http://google.com"
