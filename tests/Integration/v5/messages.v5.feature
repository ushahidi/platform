...
Feature: Testing the Messages API
    ...
    Scenario: Creating a new Message
        ...
        And the "result.message" property equals "Test creating outgoing"
        And the "result.status" property equals "pending"
    ...
    Scenario: Replying to a message
        ...
        And the response has a "result.id" property
        And the type of the "result.id" property is "numeric"
        And the "result.message" property equals "Test message reply"
        And the "result.status" property equals "pending"
        And the "result.type" property equals "sms"
        And the "result.data_source" property equals "smssync"
        And the "result.contact_id" property equals "3"
        And the "result.parent_id" property equals "9"
        Then the guzzle status code should be 200
    ...
    Scenario: Updating an outgoing message should only update status
        ...
        And the response has a "result.id" property
        And the type of the "result.id" property is "numeric"
        And the "result.id" property equals "7"
        And the "result.message" property equals "Updated message"
        And the "result.status" property equals "cancelled"
        Then the guzzle status code should be 200
    ...
    Scenario: Finding a Post from a Message
        ...
        Then the response is JSON
        And the "result.id" property equals "110"
        Then the guzzle status code should be 200
