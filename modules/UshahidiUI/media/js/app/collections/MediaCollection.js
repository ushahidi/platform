...
define(['jquery', 'backbone', 'models/MediaModel', 'App','backbone-pageable'],
	function($, Backbone, MediaModel, App, PageableCollection)
	{
		// Creates a new Backbone Collection class object
		var MediaCollection = PageableCollection.extend(
		{
			model : MediaModel,
